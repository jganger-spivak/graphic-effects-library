...
class Application(tk.Frame):
    def __init__(self, master=None, width=400, height=400):
        ...
        self.selectedcmd.set(self.cmds[1])
    ...
    def add_element(self):
        ...
        if self.selectedcmd.get() == 'RECT':
            self.loadedText += '\nRGB: ' + str(self.rvalue.get()) + ', ' + str(self.gvalue.get()) + ', ' + str(self.bvalue.get()) + '\nRECT: (' + str(self.x.get()) + ', ' + str(self.y.get()) + ', ' + str(self.width.get()) + 'x'  + str(self.height.get()) + ')'
            pygame.draw.rect(self.screen, self.color, pygame.Rect(int(self.x.get()*self.scalar.get()), int(self.y.get()*self.scalar.get()), int(self.width.get()*self.scalar.get()), int(self.height.get()*self.scalar.get())))
        if self.selectedcmd.get() == 'RGB':
            self.color = pygame.Color(self.rvalue.get(), self.gvalue.get(), self.bvalue.get())
